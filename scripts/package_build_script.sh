...
#
# This script builds revsw-firewall-manager Debian package
#
...
PACKAGENAME=revsw-firewall-manager
...
Description: nuu:bit Firewall Manager Service" >> $foldername/DEBIAN/control


mkdir -p $foldername/opt/$PackageName/

cp -rf  $WORKSPACE/code-dir/*  $foldername/opt/$PackageName/
